  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-12">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#467235]/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#FFBF00]/10 rounded-full blur-3xl" />
      </div>
      ...
      >
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#EEEEEE] mb-2">Welcome Back</h1>
            <p className="text-[#EEEEEE]/60">Sign in to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-black/50 text-[#FFBF00] focus:ring-[#FFBF00]"
                />
                <span className="text-sm text-[#EEEEEE]/60">Remember me</span>
              </label>
              <Link
                href="#"
                className="text-sm text-[#FFBF00] hover:text-[#FFBF00]/80 transition-colors"
              >
                Forgot password?
              </Link>
            </motion.div>
            ...
            >
              <button
                type="submit"
                disabled={isLoading}
                className="w-full h-12 bg-[#FFBF00] text-black font-semibold rounded-xl hover:bg-[#FFBF00]/90 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isLoading ? (
                  <motion.div
                    animate={{ rotate: 360 }}
          ...
          >
            ...
            <span className="text-sm text-[#EEEEEE]/40">or continue with</span>
            <div className="flex-1 h-px bg-white/10" />
          </motion.div>
